...
/**
 * This class can replace android.util.LogUtils.
 *
 * @description And you can turn off the log by set DEBUG_LEVEL = LogUtils.ASSERT.
 */
public final class LogUtils {
    ...
    /**
     * Master switch.To catch error info you need set this value below LogUtils.WARN
     */
...
//        }
     ...
     *            identifies the class or activity_sell where the log call occurs.
